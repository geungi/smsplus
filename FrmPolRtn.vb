Public Class FrmPolRtn
    ...
    Private Sub FrmQCLine_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Query_Combo2(Me.ComboBoxEx5, "TBL_CODEMASTER", "CODE_NAME", "CODE_ID", "site_id = '" & Site_id & "' and CLASS_ID = 'R0001' AND CODE_ID IN ('K8000','K8300','K3900') AND active = 'Y' ORDER BY CODE_ID", False) = True Then
            Me.ComboBoxEx5.SelectedIndex = 0
        End If
        'If Query_Combo(Me.ComboBoxEx5, "SELECT SUP_NM FROM TBL_SUPMST WHERE site_id = '" & Site_id & "' and SUP_NO LIKE 'P%' ORDER BY SUP_NO") = True Then
        '    Me.ComboBoxEx5.SelectedIndex = 0
        'End If
        ...
        With FpSpread1.ActiveSheet
            ...
            For i = 0 To .ColumnCount - 1
                fp_rs = Query_RS_ALL("select code_id from tbl_defect where site_id = '" & Site_id & "' and code_id like '" & Mid(.ColumnHeader.Columns(i).Label, 1, 1) & "%' order by code_id")
    ...
    Private Sub FpSpread1_ButtonClicked(ByVal sender As Object, ByVal e As FarPoint.Win.Spread.EditorNotifyEventArgs) Handles FpSpread1.ButtonClicked
        ...
        With FpSpread1.ActiveSheet
            ...
            For i = 0 To .ColumnCount - 1
                fp_rs = Query_RS_ALL("select code_id from tbl_defect where site_id = '" & Site_id & "' and code_id like '" & .ColumnHeader.Columns(i).Label & "%' order by code_id")
        ...
        If SPREAD_DUP_CHECK(FpSpread4, b.Text, 0) = True Then
            ...
            FpSpread4.ActiveSheet.SetValue(FpSpread4.ActiveSheet.RowCount - 1, 0, b.Text)
    ...
    Private Sub TextBoxX3_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TextBoxX3.KeyDown
        ...
        If LOT_VERIFY(Me.TextBoxX3, e) = True Then
            ...
            qc_rs = Query_RS_ALL("select model, (SELECT CODE_NAME FROM TBL_CODEMASTER WHERE CLASS_ID = 'R0001' AND CODE_ID = A.C_PRC), init_qty, act_qty from tbl_lotmaster A where site_id = '" & Site_id & "' and lot_no = '" & TextBoxX3.Text & "'")
            ...
            With FpSpread2.ActiveSheet
                ...
                If Insert_Data("EXEC SP_COMMON_LOTSAVE '" & Site_id & "','" & TextBoxX3.Text & "','" & FpSpread4.ActiveSheet.GetValue(0, 0) & "','','N/A',0,'폴리싱 불량','" & Emp_No & "','폴리싱','" & ComboBoxEx5.Text & "','" & OP_No & "','C1000', " & IntegerInput1.Text) = True Then
                End If

                If Insert_Data("exec SP_COMMON_WKRESULT_FAIL '" & Site_id & "','폴리싱','" & OP_No & "','" & qc_rs(0).Value & "','" & TextBoxX3.Text & "'," & IntegerInput1.Text) = True Then
                End If
                ...
                .SetValue(0, 4, FpSpread4.ActiveSheet.GetValue(0, FpSpread4.ActiveSheet.ColumnCount - 1))
                'Next



                'If Insert_Data("EXEC SP_COMMON_LOTSAVE '" & Site_id & "','" & TextBoxX3.Text & "','폴리싱 불량','" & qc_rs(1).Value & "','" & Emp_No & "'," & IntegerInput1.Text & ",'" & ComboBoxEx5.Text & "','" & FpSpread4.ActiveSheet.GetValue(0, 0) & "'") = True Then
                'End If

                'If Insert_Data("exec SP_COMMON_WKRESULT_FAIL '" & Site_id & "','" & qc_rs(1).Value & "','" & OP_No & "','" & qc_rs(0).Value & "','" & TextBoxX3.Text & "'," & IntegerInput1.Text) = True Then
                'End If
    ...
    Private Sub IntegerInput1_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
