Public Class FrmFinalFail
    ...
    Private Sub FpSpread1_ButtonClicked(ByVal sender As Object, ByVal e As FarPoint.Win.Spread.EditorNotifyEventArgs) Handles FpSpread1.ButtonClicked
        ...
        If SPREAD_DUP_CHECK(FpSpread4, FpSpread1.ActiveSheet.GetValue(e.Row, e.Column), 0) = True Then
        ...
        If LOT_VERIFY(Me.TextBoxX3, e) = True Then
            ...
            With FpSpread2.ActiveSheet
                For I As Integer = 0 To FpSpread4.ActiveSheet.RowCount - 1
                    If Insert_Data("EXEC SP_COMMON_LOTSAVE '" & Site_id & "','" & TextBoxX3.Text & "','" & FpSpread4.ActiveSheet.GetValue(I, 0) & "','','N/A',0,'출하 검사 불량','" & Emp_No & "','FINAL QC','" & ComboBoxEx6.Text & "','" & OP_No & "','C1000', " & FpSpread4.ActiveSheet.GetValue(I, FpSpread4.ActiveSheet.ColumnCount - 1)) = True Then
                    End If

                    If Insert_Data("exec SP_COMMON_WKRESULT_FAIL '" & Site_id & "','FINAL QC','" & OP_No & "','" & qc_rs(0).Value & "','" & TextBoxX3.Text & "'," & FpSpread4.ActiveSheet.GetValue(I, FpSpread4.ActiveSheet.ColumnCount - 1)) = True Then
                    End If
