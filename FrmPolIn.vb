Public Class FrmPolIn
    ...
    Private Sub FrmPartTransfer_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Spread_Setting(FpSpread2, "FrmPolOut") = True Then
        ...
        If Spread_Setting(FpSpread3, "FrmPolOut") = True Then
            FpSpread3.ActiveSheet.ColumnHeader.Columns(1).Label = "입고 수량"
    ...
    Private Sub FindBtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles FindBtn.Click
        ...
        End If
        qry = qry & "AND LOT_NO LIKE 'POL%'" & vbNewLine
        ...
        Try
            ...
            With FpSpread3.ActiveSheet
                If .RowCount > 0 Then
                    ...
                    If Mid(.GetValue(e.Row, 0), 1, 4) = "POL1" Then
                        .Cells(e.Row, 1).Locked = False
                        .Cells(e.Row, 2).Locked = True
                    End If
                    If Mid(.GetValue(e.Row, 0), 1, 4) = "POL2" Then
                        .Cells(e.Row, 2).Locked = False
                        .Cells(e.Row, 1).Locked = True
                    End If

                    .Cells(e.Row, 3).Locked = False

                    Dim J As String() = SPREAD_SEARCH(Me.FpSpread2, 0, .Cells(e.Row, 0).Text, 0, 0, Me.FpSpread2.ActiveSheet.RowCount - 1, 0, False)
                    If J(0) > -1 Then
        ...
        Try
            ...
            If S3.RowCount > 0 Then
                ...
                For i = 0 To S3.RowCount - 1
                    ...
                    Dim QRY As String = "EXEC SP_FRMPOLIN_LOTSAVE '" & Site_id & "','" & S3.GetValue(i, 0) & "'," & S3.GetValue(i, 1) & ",0,'" & Emp_No & "','" & Mid(S3.GetValue(i, 0), 6, Len(S3.GetValue(i, 0)) - 5) & "'"
