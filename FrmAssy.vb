...
Public Class FrmAssy
    ...
    Private Sub FrmTechnician_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Query_Combo(Me.ComboBoxEx9, "EXEC SP_COMMON_FINDWC '" & Site_id & "','R0001','K5000', 'GOOD' ") = True Then
    ...
    Private Sub TextBoxX1_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TextBoxX1.KeyDown
        ...
        If LOT_VERIFY(Me.TextBoxX1, e) = True Then
            ...
            Else
                ...
                If Query_Combo(Me.ComboBoxEx9, "EXEC SP_COMMON_FINDWC '" & Site_id & "','" & FpSpread1.ActiveSheet.GetValue(1, 1) & "','K5000', 'GOOD' ") = True Then
                    ComboBoxEx9.Text = ComboBoxEx9.Items(0)
                End If
        ...
        Try
            ...
            If FpSpread3.ActiveSheet.RowCount < 1 Then
                ...
                If r = Windows.Forms.DialogResult.Cancel Then
                    Exit Sub
                Else
                    If Insert_Data("EXEC SP_COMMON_LOTSAVE '" & Site_id & "','" & FpSpread1.ActiveSheet.Cells(0, 1).Text & "','','','N/A',0,'" & ComboBoxEx8.Text & "','" & WH_NO & "','" & FpSpread1.ActiveSheet.Cells(0, 5).Text & "','" & ComboBoxEx9.Text & "','" & OP_No & "','" & WH_NO & "', 0") = True Then
