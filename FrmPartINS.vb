Public Class FrmPartINS
    ...
    Private Sub FindBtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles FindBtn.Click
        ...
        qry = qry & "where part_no LIKE '" & PartNoTxt.Text & "%'" & vbNewLine
        qry = qry & "  AND O_QTY > ISNULL((SELECT SUM(GOOD_QTY + BAD_QTY) FROM TBL_PARTINS WHERE po_no = a.po_no and part_no = a.part_no),0)" & vbNewLine
    ...
    Private Sub FpSpread_Fill(ByVal rowidx As Integer) '파트리스트에서 선택한 파트를 해당 스프레드시트에 넣고, 넣은 파트는 리스트에서 삭제
        Try
            ...
            S3.Cells(S3.RowCount - 1, 4).Text = ""
            S3.Cells(S3.RowCount - 1, 5).Text = Now
        ...
        Try
            ...
            If S3.RowCount > 0 Then
                ...
                For i = 0 To S3.RowCount - 1
                    ...
                    Dim QRY As String = "EXEC SP_FRMPARTINS_INSINV '" & Site_id & "','" & S3.GetValue(i, 0) & "','" & S3.GetValue(i, 1) & "'," & S3.GetValue(i, 2) & "," & S3.GetValue(i, 3) & ",'" & S3.GetValue(i, 4) & "','" & S3.GetValue(i, 5) & "','" & Emp_No & "'"
