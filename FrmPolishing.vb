...
Public Class FrmPolishing
    ...
    Private Sub FrmTechnician_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Query_Combo(Me.ComboBoxEx9, "EXEC SP_COMMON_FINDWC '" & Site_id & "','R0001','K3000', 'GOOD' ") = True Then
    ...
    Private Sub TextBoxX1_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TextBoxX1.KeyDown
        ...
        If LOT_VERIFY(Me.TextBoxX1, e) = True Then
            ...
            If Query_RS("select c_prc from tbl_lotmaster where lot_no = '" & TextBoxX1.Text & "'") <> "K3000" Then
                Modal_Error("폴리싱 공정의 LOT번호가 아닙니다." & vbNewLine & TextBoxX1.Text)
                Me.TextBoxX1.Focus()
                Me.TextBoxX1.SelectAll()
                Exit Sub
            End If
            ...
            Else
                ...
                If Query_Combo(Me.ComboBoxEx9, "EXEC SP_COMMON_FINDWC '" & Site_id & "','" & FpSpread1.ActiveSheet.GetValue(1, 1) & "','K3000', 'GOOD' ") = True Then
                    ComboBoxEx9.Text = ComboBoxEx9.Items(0)
                End If
    ...
    Private Sub ButtonItem3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonItem3.Click, SaveBtn1.Click
        Try
            ...
            If Insert_Data("EXEC SP_COMMON_LOTSAVE_POLISHING '" & Site_id & "','" & FpSpread1.ActiveSheet.Cells(0, 1).Text & "','','','N/A',0,'GIB수리','" & Emp_No & "','" & FpSpread1.ActiveSheet.Cells(0, 5).Text & "','" & ComboBoxEx9.Text & "','" & OP_No & "','" & WH_NO & "', " & IntegerInput1.Text & ", '" & PBOX & "','" & ComboBoxEx1.Text & "','" & Mid(ComboBoxEx4.Text, 2, 10) & "','" & DateTimeInput1.Text & "'") = True Then
            End If
